...
export const createSupplies = createAsyncThunk(
  "projects/createProject",
  async (values) => {
    try {
      const response = await api.createSupplies(values)
...
export const getRelatedTours = createAsyncThunk(
  ...
  const suppliesSlice = createSlice({
    ...
    extraReducers: {
      [createSupplies.pending]: (state, action) => {
        state.loading = true;
      },
      [createSupplies.fulfilled]: (state, action) => {
        state.loading = false;
        state.projects = action.payload;
      },
      [createSupplies.rejected]: (state, action) => {
        state.loading = false;
