...
export const createAdmission = createAsyncThunk(
  ...
  async (values) => {
    try {
      const response = await api.createAdmission(values)
...
export const getRelatedTours = createAsyncThunk(
  ...
  const admissionSlice = createSlice({
    ...
    extraReducers: {
      [createAdmission.pending]: (state, action) => {
        state.loading = true;
      },
      [createAdmission.fulfilled]: (state, action) => {
        state.loading = false;
        state.projects = action.payload;
      },
      [createAdmission.rejected]: (state, action) => {
        state.loading = false;
