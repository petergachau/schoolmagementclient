...
export const createCareTakercomplain = createAsyncThunk(
  "projects/createComplain",
  async (values) => {
    try {
      const response = await api.createcaretakernotice(values)
...
export const getRelatedTours = createAsyncThunk(
  ...
  const caretakercomplainSlice = createSlice({
    name: "caretakercomplain",
    initialState: {
      tour: {},
      tours: [],
      userTours: [],
    ...
    extraReducers: {
      [ createCareTakercomplain.pending]: (state, action) => {
        state.loading = true;
      },
      [ createCareTakercomplain.fulfilled]: (state, action) => {
        state.loading = false;
        state.projects = action.payload;
      },
      [ createCareTakercomplain.rejected]: (state, action) => {
        state.loading = false;
  ...
  export default caretakercomplainSlice.reducer;