...
export const createBoarding = createAsyncThunk(
  "projects/createProject",
  async (values) => {
    try {
      const response = await api.createBoarding(values)
...
export const getRelatedTours = createAsyncThunk(
  ...
  const boardingSlice = createSlice({
    ...
    extraReducers: {
      [createBoarding.pending]: (state, action) => {
        state.loading = true;
      },
      [createBoarding.fulfilled]: (state, action) => {
        state.loading = false;
        state.projects = action.payload;
      },
      [createBoarding.rejected]: (state, action) => {
        state.loading = false;
